...
public class UserDto {
	...
	@Override
	public int hashCode() {
		return Objects.hash(city, country, dob, email, gender, name, password, phone, pincode, state);
	}
	@Override
	...
	public String toString() {
		return "UserDto [name=" + name + ", password=" + password + ", phone=" + phone + ", email=" + email + ", dob="
				+ dob + ", gender=" + gender + ", pincode=" + pincode + ", city=" + city + ", state=" + state
				+ ", country=" + country + "]";
	}
